...
public class ApplicationApiImpl implements ApplicationApi {
    ...
    @Override
    public ResponseEntity<ApplicationDto> scheduleInterview(Integer applicationId, ApplicationDto applicationDto) {
        val draftApplication = applicationMapper.dtoToEntity(applicationDto);
        val application = applicationService.scheduleInterview(applicationId, draftApplication);
