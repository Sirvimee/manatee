...
The hardest part and most of the time was spent figuring out how OpenApi works. 
I had not come across it before and at first it was incomprehensible how 
Dto classes and Super classes are created automatically. 
One test for validating the state transition was left undone because I already included it in the first test.
